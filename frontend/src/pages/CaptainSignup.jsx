...
const CaptainSignup = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link to={'/captain-login'} className='text-white font-semibold mb-5 rounded px-4 py-2 w-full text-lg bg-[#c559b9] hover:bg-[#c167b6] flex items-center justify-center'>Sign Up as a User</Link>
      </div>
    </div>
  )
}
